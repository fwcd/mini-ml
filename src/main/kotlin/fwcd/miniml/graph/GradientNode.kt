...
class GradientNode(private val delegate: ValueNode) : ValueNode {
	...
	fun sigmoid(): GradientNode = GradientNode(Sigmoid(this))
	
	fun tanh(): GradientNode = GradientNode(Tanh(this))
	
	fun sin(): GradientNode = GradientNode(Sin(this))
	
	fun cos(): GradientNode = GradientNode(Cos(this))
	
	fun tan(): GradientNode = GradientNode(Tan(this))
	
	fun exp(): GradientNode = GradientNode(Exp(this))
	
	fun log(): GradientNode = GradientNode(NaturalLog(this))
